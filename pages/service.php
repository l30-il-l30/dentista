...
$index = isset($_GET['i']) ? (int)$_GET['i'] - 1 : -1;
...
if($index < 0 || $index >= count($treatments) || !isset($treatments[$index])) {
    header("HTTP/1.0 404 Not Found");
    include "../404.php";
    exit();
}
    ...
    <section class="treatment-gallery section">
        <div class="container">
            ...
            <div class="gallery-grid">
                <?php
                $treatmentDir = "../assets/img/" . htmlspecialchars(strtolower($treatment['title']));
                for($i = 1; $i <= 4; $i++) :
                    $imagePath = $treatmentDir . "/" . $i . ".png";
                    if (file_exists($imagePath)) :
                        ?>
                        <div class="gallery-item">
                            <img src="<?php echo $imagePath; ?>" alt="Immagine trattamento <?php echo $i; ?>">
                        </div>
                    <?php
                    endif;
                endfor;
